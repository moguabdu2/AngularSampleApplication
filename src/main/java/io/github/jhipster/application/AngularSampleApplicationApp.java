...
public class AngularSampleApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(AngularSampleApplicationApp.class);

    private final Environment env;

    public AngularSampleApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes AngularSampleApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AngularSampleApplicationApp.class);
